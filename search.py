...
def tree_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print "Numero nodos expandidos: ", count
            return node
...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print "Numero nodos expandidos: ", len(closed)
            return node
...
# busqueda de ramificacion y acotacion
def ramiAcota_first_graph_search(problem):
    return tree_search(problem, RamiQueue())

def ramiAcotaSub_first_graph_search(problem):
    return tree_search(problem, RamiSubQueue(problem))
#______________________________________________________________________________
...
def heuristic_first_graph_search(problem):
    return tree_search(problem, HeuristicQueue(problem))
